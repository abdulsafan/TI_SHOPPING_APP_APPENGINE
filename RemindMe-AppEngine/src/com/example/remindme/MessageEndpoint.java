 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "example.com", ownerName = "example.com", packagePath="remindme"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyC6wP11fgtNDyo8_TyX83soUpgDPWJIG04";
   ...
   * will also broadcast the message to up to 10 registered android devices
